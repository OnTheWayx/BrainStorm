...
QT_MOC_LITERAL(4, 30, 14), // "userOnlineInfo"
QT_MOC_LITERAL(5, 45, 15), // "allowToSendFile"
QT_MOC_LITERAL(6, 61, 14), // "finishSendFile"
QT_MOC_LITERAL(7, 76, 8) // "readData"

    },
    "Communicate\0loginResult\0\0json\0"
    "userOnlineInfo\0allowToSendFile\0"
    "finishSendFile\0readData"
};
...
void Communicate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->loginResult((*reinterpret_cast< QJsonObject(*)>(_a[1]))); break;
        case 1: _t->userOnlineInfo((*reinterpret_cast< QJsonObject(*)>(_a[1]))); break;
        case 2: _t->allowToSendFile(); break;
        case 3: _t->finishSendFile(); break;
        ...
        {
            typedef void (Communicate::*_t)(QJsonObject );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Communicate::userOnlineInfo)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Communicate::allowToSendFile)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (Communicate::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Communicate::finishSendFile)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 1
void Communicate::userOnlineInfo(QJsonObject _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void Communicate::allowToSendFile()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void Communicate::finishSendFile()
{
